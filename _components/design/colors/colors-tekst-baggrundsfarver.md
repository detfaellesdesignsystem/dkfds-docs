...
<div class="color-row-container">
  <div class="row color-row">
    <div class="col-12 col-md-6">
      ...
      <div class="color-container-small bordered color-white mt-0">
        <div class="color-text-container">
          <span class="text-black">Normal tekst på hvid</span>
        </div>
      </div>
      <!-- black-on-white end -->
      <!-- black-on-pale start -->
      <div class="color-container-small color-gray-pale">
        <div class="color-text-container">
          <span class="text-black">Normal tekst på grå</span>
        </div>
      </div>
      <!-- black-on-pale end -->
      <!-- gray-on-white start -->
      <div class="color-container-small bordered color-white">
        <div class="color-text-container">
          <span class="form-hint">Hjælpetekst på hvid</span>
        </div>
      </div>
      <!-- gray-on-white end -->
      ...
      <div class="color-container-small color-gray-pale">
        <div class="color-text-container">
          <span class="form-hint">Hjælpetekst på grå</span>
        </div>
      </div>
      <!-- gray-on-white end -->
      <!-- link-on-white start -->
      <div class="color-container-small bordered color-white">
        <div class="color-text-container">
          <span><a href="#">Link på hvid</a></span>
        </div>
      </div>
      <!-- link-on-white end -->
      <!-- link-on-gray start -->
      <div class="color-container-small color-gray-pale">
        <div class="color-text-container">
          <span><a href="#">Link på grå</a></span>
        </div>
      </div>
      <!-- link-on-gray end -->
    </div>
    <div class="col-12 col-md-6">
      ...
      <div class="color-container-small bordered color-white mt-0">
        <div class="color-text-container">
          <span class="text-negative">Negativ tekst på hvid</span>
        </div>
      </div>
      ...
      <div class="color-container-small color-gray-pale">
        <div class="color-text-container">
          <span class="text-negative">Negativ tekst på grå</span>
        </div>
      </div>
      ...
      <div class="color-container-small bordered color-white">
        <div class="color-text-container">
          <span class="text-positive">Positiv tekst på hvid</span>
        </div>
      </div>
      ...
      <div class="color-container-small color-gray-pale">
        <div class="color-text-container">
          <span class="text-positive">Positiv tekst på grå</span>
        </div>
      </div>
