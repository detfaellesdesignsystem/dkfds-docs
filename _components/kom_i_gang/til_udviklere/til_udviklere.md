...
<p>Hent nyeste <a href="https://github.com/detfaellesdesignsystem/dkfds-components/releases" class="icon-link">version som zipfil på Github<svg class="icon-svg" focusable="false" aria-hidden="true" tabindex="-1"><use xlink:href="#open-in-new"></use></svg></a></a>, og pak indholdet ud i dit projekt.</p>
...
<p>Har du brug for dit eget tema? Så læs sektionen om, hvordan du tilpasser dkfds til dit eget tema.</p>
...
<p>Designsystemer er udviklet med 2 forskellige temaer. Standard temaet er det neutrale tema hvor primærfarven er grå. Denne grå farve skal som minimum overskrives, da det neutrale tema blot er ment som en skabelon til sit eget tilpassede tema. De to andre temaer er målrettet borger.dk og virk.dk.</p>
