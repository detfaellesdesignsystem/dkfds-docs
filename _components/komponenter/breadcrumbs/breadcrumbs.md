...
- <a href="https://ui-patterns.com/patterns/Breadcrumbs" class="icon-link">https://ui-patterns.com/patterns/Breadcrumbs<svg class="icon-svg" focusable="false" aria-hidden="true" tabindex="-1"><use xlink:href="#open-in-new"></use></svg></a>
