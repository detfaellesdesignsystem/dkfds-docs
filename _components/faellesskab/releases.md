...
- <label class="color-warning badge badge-small mr-3">Breaking change</label>Ændret attributter på <a href="/komponenter/tjekboks/#skjult-indhold-collapse">tjekboks med collapse funktion</a>, så HTML nu er valid.
...
- <label class="color-warning badge badge-small mr-3">Breaking change</label>Skjul/vis indhold med knap er fjernet.
- <label class="color-warning badge badge-small mr-3">Breaking change</label><a href="/komponenter/cookiemeddelelse/">Cookiemeddelelse</a> opdateret i udseende og HTML.
...
- <label class="color-warning badge badge-small mr-3">Breaking change</label><a href="/komponenter/faneblad/" title="Læs mere om faneblads-komponenten">Fanebladskomponenten</a> er ændret i HTML og JavaScript.
...
- <label class="color-info badge badge-small mr-3">Change</label>Tilføjet korrekte ARIA attributer på <a href="/kode/komponenter/sidenav/" title="Se koden til sidenavigationen">sidenavigationen</a>, <a href="/kode/komponenter/headers/" title="Se koden til mobilmenu og headermenu">mobilmenu og headermenuen</a>.
...
- <span class="color-info badge badge-small mr-3">Change</span>Fjernet fast højde på tekstområde (textarea) - man kan/bør nu sætte højden med rows attributten.
...
- <span class="color-info badge badge-small mr-3">Change</span>Log ud skal nu hedde Log af.
