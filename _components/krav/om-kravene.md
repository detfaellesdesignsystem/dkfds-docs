...
- Eksterne krav: krav fra eksterne kilder som fc lovgivning og sikkerhedsstandarder.
...
<a href="https://arkitektur.digst.dk/faelles-krav-til-digitale-loesninger-vaerktoej-til-identifikation-af-krav" class="icon-link">Se hvilke krav og anbefalinger, der gælder din løsning<svg class="icon-svg" focusable="false" aria-hidden="true" tabindex="-1"><use xlink:href="#open-in-new"></use></svg></a>
