...
<main class="container page-container">
    ...
    <p class="mt-0">Forsikringens Forsikringsfirma</p>
    <div class="mt-5">
        <label class="form-label">Afsender er</label>
        ...
        <div class="form-group mt-3">
            <input id="id-afsender4" type="radio" name="afsender"
                value="Erstatningsnævnet" class="form-radio  radio-large ">
            <label for="id-afsender4" class="radio-large">Erstatningsnævnet
            </label>
        </div>
