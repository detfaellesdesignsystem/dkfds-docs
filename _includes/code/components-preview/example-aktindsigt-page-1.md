...
<main class="container page-container">
    ...
    <form class="form" method="post"
        action="/pages/eksempler/aktindsigt/aktindsigt-2/">
        <div role="group" aria-describedby="oplysninger-om-dig">
            ...
            <div class="form-group">
                <label class="form-label " for="id-fornavn"
                    id="form-label-id-fornavn">
                    Fornavn
                </label>

                <input class="form-input  input-width-m " id="id-fornavn"
                    value="" name="Input til fornavn" type="text">
            </div>
            <div class="form-group">
                <label class="form-label " for="id-efternavn"
                    id="form-label-id-efternavn">
                    Efternavn
                </label>

                <input class="form-input  input-width-m " id="id-efternavn"
                    value="" name="Input til efternavn" type="text">
            </div>
            <div class="form-group">
                <label class="form-label " for="id-gade-vej"
                    id="form-label-id-gade-vej">
                    Gade/vej
                </label>

                <input class="form-input  input-width-m " id="id-gade-vej"
                    value="" name="Input til gade/vej" type="text">
            </div>
            <div class="form-group">
                <label class="form-label " for="id-husnummer"
                    id="form-label-id-husnummer">
                    Husnummer
                </label>
            ...
            <div class="form-group">
                <label class="form-label " for="id-etage"
                    id="form-label-id-etage">
                    Etage<span class="weight-normal"> (frivilligt)</span>
                </label>

                <input class="form-input  input-width-xxs " id="id-etage"
                    value="" name="Input til etage" type="text">
            </div>
            <div class="form-group">
                <label class="form-label " for="id-side"
                    id="form-label-id-side">
                    Side<span class="weight-normal"> (frivilligt)</span>
                </label>
                <span class="form-hint" id="input-hint-message-id-side">
                    Fx: TV, 2. dør
                </span>

                <input class="form-input  input-width-xs " id="id-side"
                    value="" name="Input til side" type="text"
                    aria-labelledby="form-label-id-side input-hint-message-id-side">
            </div>
            <div class="form-group">
                <label class="form-label " for="id-postnummer"
                    id="form-label-id-postnummer">
                    Postnummer
                </label>
            ...
            <div class="form-group">
                ...
                <input class="form-input  input-width-m " id="id-by"
                    value="" name="Input til by" type="text">
            </div>
            <div class="form-group">
                <label class="form-label " for="id-co-adresse"
                    id="form-label-id-co-adresse">
                    Evt. CO-adresse<span class="weight-normal">
                        (frivilligt)</span>
                </label>
