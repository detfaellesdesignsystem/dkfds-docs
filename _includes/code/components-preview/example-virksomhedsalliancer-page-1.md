...
<main class="container page-container">
    ...
    <div class="form-group">
        ...
        <input class="form-input  input-width-m " placeholder=""
            id="id-companycity" value="" name="Input til by" type="text">
    </div>
    ...
    <div class="form-group">
        ...
        <input class="form-input  input-char-8 " placeholder=""
            id="id-companyphone" value="" name="Input til telefonnummer"
            type="text">
    </div>
    ...
    <div class="form-group">
        ...
        <span class="form-hint"
            id="input-hint-message-id-companyemail">Kvittering bliver sendt
            til denne e-mailadresse</span>
