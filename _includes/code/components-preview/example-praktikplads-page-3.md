        ...
        <div class="navbar">
            <div class="navbar-inner navbar-context-actions container">
                <div class="nav-actions">
                    <a href="#"
                        class="function-link"><svg class="icon-svg "  focusable="true" aria-hidden="true" tabindex="-1"><use xlink:href="#printer"></use></svg>Udskriv</a>
                    <a href=""
                        class="function-link"><svg class="icon-svg "  focusable="true" aria-hidden="true" tabindex="-1"><use xlink:href="#help-circle-outline"></use></svg>Hjælp</a>
                </div>
            </div>
        </div>
...
<main class="container page-container">
    ...
    <section class="page-content">
        ...
        <p class="mt-7 mb-0">Udbetaling af Praktikplads-AUB for 2019:
            <b>18.316,00</b></p>
