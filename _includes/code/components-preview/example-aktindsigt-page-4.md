...
<main class="container page-container">
    ...
    <button href="#"
        class="button button-secondary mt-7"><svg class="icon-svg "  ><use xlink:href="#download"></use></svg>
        Gem som pdf</button> <br>
    <button href="#"
        class="button button-secondary mt-3"><svg class="icon-svg "  ><use xlink:href="#printer"></use></svg>
        Print</button>
