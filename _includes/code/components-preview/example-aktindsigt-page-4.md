--- 
permalink: /preview-components/example-aktindsigt-page-4.html
layout: iframed 
title: Example-aktindsigt-page-4.html
---
...
<main class="container page-container">
    ...
    <div class="mt-5">
        ...
        <p class="mt-0">Vængetstræde 77 <br>
      0081 Købstad</p>
    </div>
    <div class="mt-5">
    ...
    <button href="#"
        class="button button-secondary mt-7"><svg class="icon-svg "  focusable="false" aria-hidden="true" tabindex="-1"><use xlink:href="#download"></use></svg>
        Gem som pdf</button> <br>
    <button href="#"
        class="button button-secondary mt-3"><svg class="icon-svg "  focusable="false" aria-hidden="true" tabindex="-1"><use xlink:href="#printer"></use></svg>
        Print</button>
