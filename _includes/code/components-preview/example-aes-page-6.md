    ...
    <div role="group" aria-describedby="tilfoej-documentation">
        ...
        <form class="form">
            <div class="form-group file-input">
                <label class="form-label" for="input-file">Tilføj
                    dokument</label>
        ...
        <tbody>
            <tr>
                <td class="mt-4 mt-lg-0 break-word w-percent-md-40">
                    <svg class="icon-svg "  focusable="false" aria-hidden="true" ><use xlink:href="#file"></use></svg>prn1023152_journal.pdf
                </td>
                <td class="mt-4 mt-lg-0">
                    ...
                    <div class="form-group ">
                        ...
                        <select class="[object Object] form-select"
