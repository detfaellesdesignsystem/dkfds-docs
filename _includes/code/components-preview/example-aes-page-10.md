...
<main class="container page-container">
    ...
    <button
        class="button button-secondary d-print-none"><svg class="icon-svg "  focusable="true" aria-hidden="true" tabindex="-1"><use xlink:href="#download"></use></svg>
    ...
    <p>Gebyr: 6.220 kr.
        ...
        <p>Kontakt AES på aes@aes.dk eller 72 00 60 00
            ...
            <button class="button button-secondary mt-7 d-print-none">Opret
                ny sag</button>
</main>
