            ...
            <p class="mt-6">Hvis ansøger er ejet af moderselskab(-er) med
                ...
                <div class="form-group">
                    <label class="form-label " for="id-employees"
                        id="form-label-id-employees">
                        Antal ansatte i seneste regnskabsår
                    </label>
                ...
                <div class="form-group">
                    <label class="form-label " for="id-sales"
                        id="form-label-id-sales">
                        Omsætning i DKK i seneste regnskabsår
                    </label>
                    <span class="form-hint"
                        id="input-hint-message-id-sales">
                        Angives i helt tal, fx. 11.650.334
                    </span>

                    <input class="form-input  input-width-m " id="id-sales"
                        value=""
