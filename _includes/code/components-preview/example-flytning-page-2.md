            ...
            <div class="navbar-inner navbar-context-actions container">
                <div class="nav-actions">
                    <a href="#"
                        ...
                        digital flytning</a>
                    <a href=""
                        class="function-link"><svg class="icon-svg "  focusable="true" aria-hidden="true" tabindex="-1"><use xlink:href="#language"></use></svg>Sprog</a>
                </div>
            </div>
        </div>
...
<main class="container page-container">
    ...
    <div>
        <button
            class="button button-secondary d-print-none"><svg class="icon-svg "  focusable="true" aria-hidden="true" tabindex="-1"><use xlink:href="#add"></use></svg>Tilføj
            personer</button>
    </div>
