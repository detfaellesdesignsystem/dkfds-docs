...
<div id="result-container" class="d-none">
    ...
    <ul class="mt-0 form-hint">
        <li>Forvaltningsloven <a href="https://arkitektur.digst.dk/forvaltningsloven-eksterne-kilder" class="icon-link d-print-none" target="_blank" aria-label="Læs mere om eksterne krav i forhold til forvaltningsloven">Læs mere<svg class="icon-svg" focusable="false" aria-hidden="true"><use xlink:href="#open-in-new"></use></svg></a></li>
        <li>Sikkerhed <a href="https://arkitektur.digst.dk/sikkerhed-eksterne-kilder" class="icon-link d-print-none" target="_blank" aria-label="Læs mere om eksterne krav omkring sikkerhed">Læs mere<svg class="icon-svg" focusable="false" aria-hidden="true"><use xlink:href="#open-in-new"></use></svg></a></li>
        <li>Single Digital Gateway <a href="https://arkitektur.digst.dk/single-digital-gateway-eksterne-kilder" class="icon-link d-print-none" target="_blank" aria-label="Læs mere om krav i forhold til Single Digital Gateway">Læs mere<svg class="icon-svg" focusable="false" aria-hidden="true"><use xlink:href="#open-in-new"></use></svg></a></li>
        <li>Tilkobling til dansk eID-Gateway <a href="https://arkitektur.digst.dk/tilkobling-til-dansk-eid-gateway-eksterne-kilder" class="icon-link d-print-none" target="_blank" aria-label="Læs mere om eksterne krav i forhold til tilkobling til dansk eID-Gateway">Læs mere<svg class="icon-svg" focusable="false" aria-hidden="true"><use xlink:href="#open-in-new"></use></svg></a></li>
        <li>Webtilgængelighed <a href="https://arkitektur.digst.dk/webtilgaengelighed-eksterne-kilder" class="icon-link d-print-none" target="_blank" aria-label="Læs mere om eksterne krav omkring webtilgængelighed">Læs mere<svg class="icon-svg" focusable="false" aria-hidden="true"><use xlink:href="#open-in-new"></use></svg></a></li>
    </ul>
