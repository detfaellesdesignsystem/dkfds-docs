...
- <strong class="badge badge-info badge-small mr-2">Change</strong> Tilføjet `aria-haspopup` til knapper, der åbner modaler. {% include links/component-code-link.html linktext="Modalkomponenten" %}, {% include links/internal-link.html linktext="selvbetjeningseksemplerne" %} og pattern for {% include links/internal-link.html linktext="session udløber" %} er opdateret.
