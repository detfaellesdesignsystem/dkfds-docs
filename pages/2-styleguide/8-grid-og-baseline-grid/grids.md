...
<figure>
    <img src="{{ site.baseurl }}/assets/img/descriptionimages/grid-inddelinger.jpg" class="w-percent-30" alt="Første eksempelgrafik ud af fem, der viser et grid med 7 rækker og 1 til 6 kolonner" title="">
    <img src="{{ site.baseurl }}/assets/img/descriptionimages/grid-inddelinger-artikel.jpg" class="w-percent-30" alt="Anden eksempelgrafik ud af fem, der viser et grid med 5 rækker og 1 til 3 kolonner" title="">
    <img src="{{ site.baseurl }}/assets/img/descriptionimages/grid-inddelinger-nav1.jpg" class="w-percent-30" alt="Tredje eksempelgrafik ud af fem, der viser et grid med 5 rækker og 1 til 6 kolonner" title="">
    <img src="{{ site.baseurl }}/assets/img/descriptionimages/grid-inddelinger-nav2.jpg" class="mt-4 w-percent-30" alt="Fjerde eksempelgrafik ud af fem, der viser et grid med 4 rækker og 1 til 6 kolonner" title="">
    <img src="{{ site.baseurl }}/assets/img/descriptionimages/grid-inddelinger-search.jpg" class="mt-4 w-percent-30" alt="Femte eksempelgrafik ud af fem, der viser et grid med 3 rækker og 1 til 2 kolonner" title="">
...
<table class="table">
    <caption class="align-text-left mb-4">Grid systemet har følgende standardindstillinger:</caption>
    <thead>
        <tr>
            <td></td>
